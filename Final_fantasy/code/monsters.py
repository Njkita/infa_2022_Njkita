...
class Enemy(Entity):
    def __init__(self, monster_name, pos, groups, 
                 obstracle_sprites, damage_player, add_exp):
        ...
        #таймер вонзания (кулдаун неуязвимости)
        self.vulnerable = True #возможность ударить
        self.hit_time = None
        self.invisibility_duration = 300 #время неуязвимости
